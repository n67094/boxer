...
#ifndef TEST_BITSET_H_
#define TEST_BITSET_H_
...
BXR_UNIT_CASE(case_bitset_equals)
{
  bxr_bitset_t *bitset_a = bxr_bitset_make(96);
  bxr_bitset_t *bitset_b = bxr_bitset_make(96);

  BXR_UNIT_ASSERT(bxr_bitset_equals(bitset_a, bitset_b) == true);

  bxr_bitset_set(bitset_a, 0);

  BXR_UNIT_ASSERT(bxr_bitset_equals(bitset_a, bitset_b) == false);
...
BXR_UNIT_SUITE(suite_bitset)
{
  ...
  BXR_UNIT_RUN_CASE(case_bitset_equals);
}

#endif // TEST_BITSET_H_
